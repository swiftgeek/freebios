/*
 * $Id: vga_set_mode.c,v 1.1 2002/12/16 18:03:20 rminnich Exp $
 * $Source: /home/swiftgeek/Other/BIOS/Coreboot/linuxbios-legacy/cvsroot/freebios/src/pc80/vga_set_mode.c,v $
 *
 *  by
