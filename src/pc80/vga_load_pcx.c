/***********************************************************
 *
 * $Id: vga_load_pcx.c,v 1.2 2003/02/12 20:40:14 rminnich Exp $
 * $Source: /home/swiftgeek/Other/BIOS/Coreboot/linuxbios-legacy/cvsroot/freebios/src/pc80/vga_load_pcx.c,v $
 *
